...
This project is indexed by GitNexus as **patas-arriba-monorepo** (722 symbols, 1032 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
