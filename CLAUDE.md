...
This project is indexed by GitNexus as **patas-arriba-monorepo** (706 symbols, 1017 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
