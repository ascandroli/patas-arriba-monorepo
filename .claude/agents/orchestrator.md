...
2. Create a GitHub issue for the task in `ascandroli/patas-arriba-monorepo`:
   `gh issue create --repo ascandroli/patas-arriba-monorepo --title "TITLE" --body "DESCRIPTION"`
...
- You do not push (the user pushes; never run `git push` from any agent).
